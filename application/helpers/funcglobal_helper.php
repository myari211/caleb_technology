...
if( ! function_exists('cssServices')){
function cssServices($order) {

        $style='';
        $style_text='';
         if  (($order % 2) == 1)
         {
         $style = 'serive-container';
         $style_text='service-text-container';
         }
         else if (($order % 2) != 1)
         {
         $style = 'serive-container-engineering';
         $style_text='service-text-engineering-container';
         }
           return array($style_text, $style_text);
	}
   }
  if( ! function_exists('cssWorks')){
function cssWorks($order) {
        ...
        if ($order == 2){
            ...
            $class = 'do-width-dbl appear fadeIn';
        }
        else {
            $class = '';
        } 
   ...
   if( ! function_exists('aboutCSS')){
function aboutCSS($order) {

        $class='';		  
        if ($order == 1 ){
            $class = 'templatemo-hex-top2';
        }
        if ($order == 2 ){
            $class = 'hex-offset templatemo-hex-top1 templatemo-hex-top2';
        }
        if ($order == 3 ){
            $class = 'templatemo-hex-top1  templatemo-hex-top2';
        } 
        if ($order == 4 ){
            $class = 'templatemo-hex-top3';
        } 
        if ($order == 5 ){
            $class = 'templatemo-hex-top3';
        } 
