...
class Model_content extends CI_Model {
    ...
    function __construct()
    {
        parent::__construct();
		 ...
		 $query		= "SELECT a.content_page_id, a.page_type, a.content_page_title, a.content_page_short_desc,"
                                    . " a.content_page_image, a.content_page_desc, a.content_page_order, a.content_page_active_status,"
	...
	function getContentPage($id = '')
	{
		...
		$sql	= "SELECT a.content_page_id, a.menu_id, a.page_type,a.content_page_title, a.content_page_short_desc,"
                                    . " a.content_page_image, a.content_page_desc, a.content_page_active_status, "
                                    . " a.content_page_meta_description, a.content_page_meta_keywords, "
                                    . "DATE_FORMAT( a.content_page_create_date, '%d-%m-%Y %H:%i:%s' ) as content_page_create_date, a.content_page_create_by, "
                                    . " b.menu_id, b.menu_title "
                                    . "FROM tbl_content_page as a "
	...
	function updateContent($id,$menu_id,$content_title,$content_desc,$content_imageurl,$content_alias,$content_metadescription,$content_metakeywords,$content_shortdesc)
	{
        ...
        function insertContentPages($menu_id,$page_type,$content_page_title,$content_page_desc,$content_page_imageurl,$content_page_metadescription,$content_page_metakeywords,$content_page_shortdesc)
	{
	...
	function updateContentPages($id,$menu_id,$page_type,$content_page_title,$content_page_desc,$content_page_imageurl,$content_page_metadescription,$content_page_metakeywords,$content_page_shortdesc)
	{
