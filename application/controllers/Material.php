...
class Material extends MY_Controller {
	...
	public function __construct()
	{
		parent::__construct();
                session_start();
                $this->load->model(array('web/Model_content','web/Model_material','web/Model_menu','backend/Model_language','backend/Model_logcms'));
	...
	{             
                ...
                $this->data['getMaterialPage'] = $this->Model_material->getMaterialPage();
...
//        echo' <!--><pre>';
//        print_r($this->data['getMaterialPage']);
//        echo' <--><pre>';
//        die;
               
		$this->load->view('vmaterial',$this->data);
	}
}