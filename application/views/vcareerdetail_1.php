...
<html lang="en">
  ...
  <body>
   ...
   <div class="container-fluid service-motto-container register-training-wrapper">
      <form class="applyForm" id="applyForm">
        <div class="custom-container service-motto">
		  ...
		  <table id="tbl-appy">
			...
			<tr>
				<td colspan="2">
					...
					<div class="box-upload">
						<input type="file" name="file" id="file-1" class="inputfile text required requiredField" required="true"/>
			...
			<tr>
                        <td style="width: 50%;padding-right: 20px;">
                                 <div class="g-recaptcha" data-sitekey="6LdkxiYTAAAAAHF1yO0VEbiaxTy8TYrOncdzPJAm"></div>
                        </td>
			</tr>
			<tr>
                            <td><input class="submit" type="submit"  value="SUBMIT" onclick="doApply()"></td>
    ...
    <div class="custom-container service-motto thankyou" id="thankyou" style="display: none">                   
                        <h2 class="ty">THANK YOU</h2>
                        <p>YOUR APPLYCATON HAS BEEN SENT</p>
                        <div class="company-have-idea-button">
                            <input class="submit" type="submit"  value="SENT ANOTHER APPLICATION" onclick="doSend()">
