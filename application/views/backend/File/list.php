                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             <a href="<?php echo BASE_URL_BACKEND.'/Material'?>/">   <?php echo 'FILE'?> - <?php echo $breadcrump; ?></a>
                          </header>
						  <?php if(isset($error)){ ?>
						  ...
						  <?php } ?>
                                                ...
                                                <div class="panel-body">
                                                    <div class="col-lg-12" id="frmadd">
                                                        ...
                                                        <?php } ?>
                                                            <a href="<?php echo BASE_URL_BACKEND.'/product'?>/" class="btn btn-danger btn-sm" type="button"> Cancel</a>
