            ...
            <li id="photos_<?php echo $file['material_file_id']; ?>">              
				...
				<div class='photo-box'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="" readonly="readonly" id="fileupl<?php echo $file['material_file_id']; ?>" class="form-control" value="<?php echo $file['material_file']; ?>">
                                            <div style="margin-right:50px;">
                                                          <a onClick="openKCFinderFile('fileupl<?php echo $file['material_file_id']; ?>');" id="link-file" class="link" style="cursor:pointer;">Browse</a>
                                                          <a onClick="reset_value('fileupl<?php echo $file['material_file_id']; ?>');" id="link-file" class="link">Reset</a>
