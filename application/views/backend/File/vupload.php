             ...
             <div class="col-sm-8 col-md-8">
				...
				<div class="form-group">
                        ...
                        <div class="form-group">                                                    
                            ...
                            <input type="text" name="material_file[]"  id="fileurl1" class="form-control" value="">
                            ...
                            $('#fileMore').click(function() {
                                ...
                                var moreFileTag = '';
                                        ...
                                        moreFileTag += ' <div class="form-group">';
                                                    ...
                                                    moreFileTag += ' <input type="text" name="material_file[]"  id="fileurl' + file_number + '" class="form-control" value="">';
                                                    moreFileTag += '<div style="margin-right:50px;">';
                                                    moreFileTag += '<p class="help-block" style="color:#00F;">Paste Link file url source</p>';
                                                    moreFileTag += '</div>';
