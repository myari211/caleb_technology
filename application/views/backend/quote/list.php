                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                          ...
                          <div class="panel-body">
                                    <form name="form1" action="<?php echo BASE_URL_BACKEND.'/quote/doAdd'; ?>" method="post" class="form-horizontal" role="form">
                                  <?php if(isset($error)){ ?>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
										  <textarea id="IDpagesshortdesc" name="quote_desc" class="form-control" placeholder="Pages Short Description" rows="4"><?php if(!empty($quote_desc)){echo $quote_desc;} ?></textarea>
										  <script>
