          ...
          <section class="wrapper">
              ...
              <div class="row">
                ...
                <section class="panel">
                        ...
                        <div class="panel-body">
                               ...
                               <div class="form-group">
                                 ...
                                 <?php } else {?> 
                                <input type="text" name="page_type"  value="999" style="display: none"/>
                                 <?php }?> 
                                <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label"><?php echo $breadcrump['module_name']; ?> Page Title</label>
                                      <div class="col-lg-4">
                                          <input name="content_page_title" type="text" class="form-control" placeholder="Content Page Title" value="<?php if(!empty($content_page_stitle)){echo $content_page_title;} ?>">
                                      </div>
                                </div>                        
                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                    <textarea id="IDcontentdesc" name="content_page_desc" class="form-control ckeditor" placeholder="Content Page Description" rows="7"><?php if(!empty($content_page_desc)){echo $content_page_desc;} ?></textarea>
				...
				<div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input name="content_page_metadescription" type="text" class="form-control" placeholder="Content Page Meta Description" value="<?php if(!empty($content_page_metadescription)){echo $content_page_metadescription;} ?>">
                                    </div>
                                </div>
				<div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label"><?php echo $breadcrump['module_name']; ?> Page Meta Keywords</label>
                                    <div class="col-lg-4">
                                          <input name="content_page_metakeywords" type="text" class="form-control" placeholder="Content Page Meta Keywords" value="<?php if(!empty($content_page_metakeywords)){echo $content_page_metakeywords;} ?>">
                                    </div>
                                </div>
                            <?php if($NosubPage != 0) { ?> 
                                 <div class="col-lg-10 right">
                <legend>SubPage</legend>
                <section>         
                  <div class="form-group">
                        <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">SubPage Title</label>
                        <div class="col-lg-8">
                            <input name="subpage_title[]" id="subpage_title1" type="text" class="form-control" placeholder="Sub Page Title" value="">
                        </div>
                   </div>
                    <div class="form-group">
                                      <label for="inputDescription" class="col-lg-2 col-sm-2 control-label">SubPage Description</label>
                                      <div class="col-lg-8">
                                    <textarea id="IDaccordesc1" name="subpage_desc[]" class="form-control ckeditor" placeholder="SubPage Description" rows="7"></textarea>
                                       <script>
        ...
        $('#subpageMore').click(function() {
            ...
            var moreSubPageTag = '';
             ...
             moreSubPageTag += '<div class="form-group">';
                    ...
                    moreSubPageTag += '<input id="subpage_title' + subpage_number + '" name="subpage_title[]" type="text" class="form-control" placeholder="Accorddion Title" value="">';
                    moreSubPageTag += '</div>';
                    moreSubPageTag += '</div>';
                    moreSubPageTag += ' <div class="form-group">';
                    moreSubPageTag += '<label for="inputDescription" class="col-lg-2 col-sm-2 control-label">SubPage Description</label>';
                    moreSubPageTag += '<div class="col-lg-6">';
                    moreSubPageTag += '<textarea id="IDaccordescs' + subpage_number + '" name="subpage_desc[]" class="form-control ckeditor" placeholder="SubPage Description" rows="7"></textarea>';                                 
