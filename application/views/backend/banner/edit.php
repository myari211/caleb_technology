        ...
        <div class="row">                  
          <div class="col-lg-12">					
            <section class="panel">                          
              ...
              <div class="panel-body">							  
                <form name="form1" action="<?php echo BASE_URL_BACKEND.'/banner/doEdit/'.$rsBanner[0]['banner_id']; ?>" method="post" class="form-horizontal" role="form">                                  
                  ...
                  <div class="form-group">                                      
                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Banner Title
                    </label>                                      
                    <div class="col-lg-4">                                          
                  ...
                  <div class="form-group">                                      
                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Banner Type
                    </label>                                      
                    <div class="col-lg-4">                                          
                      <select name="bannertype" id="bannertypeid" class="form-control" style="width:auto;">											
                        <option value="0">Choose a banner type
                        </option>											
                        <option value="1" 
                                <?php if($rsBanner[0]['banner_type'] == 1) { echo "selected"; }?>>Home
                        </option>                                                                                        
                      <option value="2" 
                              <?php if($rsBanner[0]['banner_type'] == 2) { echo "selected"; }?>>Midle Slide
                      </option>											
                    <p class="help-block" style="color:#00F;">width and height optimal is 1920px x 1080px (Home)
                    </p>										  
                    </select>									  
                  </div>                                  
              </div>
               <div class="form-group">
                                      ...
                                      <div class="col-lg-4">
                                                   <?php $banner_image_thumbs = BASE_URL.str_replace('/admin/images','/admin/.thumbs/images',$rsBanner[0]['banner_images']);										
                                                    $banner_image = BASE_URL.$rsBanner[0]['banner_images']; ?>
                                           <div style="margin-bottom:10px;" class="imageurl">
                                                <img id="imgurl" src="<?php echo $banner_image; ?>" style="max-width:400px; padding:5px; border:solid 1px #ccc;">                                   
                                                </div>
                                                <input type="text" name="bannersimageurl" readonly="readonly" id="imageurl" class="form-control" value="<?php echo $banner_image ?>" onchange="setVal(this);">
              ...
              <div class="form-group">                                      
                <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Banner URL
                </label>                                      
                <div class="col-lg-4">                                          
              ...
              <div class="form-group">                                      
                <label for="inputDescription" class="col-lg-2 col-sm-2 control-label">Banner Description
                </label>                                      
                <div class="col-lg-10">										  
                  <textarea id="bannerdesc" name="bannerdesc" class="form-control ckeditor" placeholder="Content Description" rows="7">
                    <?php echo $rsBanner[0]['banner_desc']; ?>
                  </textarea>											
                  <script>												CKEDITOR.replace( 'bannerdesc', {
...
<script src="<?php echo JS_BASE_URL; ?>/jquery.js">
</script>    
...
<script src="<?php echo JS_BASE_URL; ?>/jquery.scrollTo.min.js">
</script>    
<script src="<?php echo JS_BASE_URL; ?>/jquery.nicescroll.js" type="text/javascript">
</script>    
