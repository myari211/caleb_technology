...
<form name="form1" action="
									<?php echo BASE_URL_BACKEND.'/'.$controller.'/doAddContent'; ?>" method="post" class="form-horizontal" role="form">
    <?php if(isset($error)){ ?>
        ...
        <?php } ?>
            <input type="text" name="menu_id" id="echoActive" value="
										<?php echo $menu_id;?>" style="display: none" />
            <div class="form-group">
                <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">
                    <?php echo $breadcrump['module_name']; ?> Title
                </label>
                <div class="col-lg-4">
                    <input name="content_title" type="text" class="form-control" placeholder="Content Title" value="
                    <?php if(!empty($contenttitle)){echo $contenttitle;} ?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input name="content_alias" type="text" class="form-control" placeholder="Content Alias" value="
															<?php if(!empty($contentalias)){echo $contentalias;} ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">
                ...
                <div class="col-lg-4">
                    <input name="content_metadescription" type="text" class="form-control" placeholder="Content Meta Description" value="
																<?php if(!empty($contentmetadescription)){echo $contentmetadescription;} ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">
                ...
                <div class="col-lg-4">
                    <input name="content_metakeywords" type="text" class="form-control" placeholder="Content Meta Keywords" value="
																	<?php if(!empty($contentmetakeywords)){echo $contentmetakeywords;} ?>">
                </div>
            </div>
            <div class="form-group">
