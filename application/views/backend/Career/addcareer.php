              ...
              <div class="row">
                ...
                <section class="panel">
                        ...
                        <div class="panel-body">
                                <form name="form1" action="<?php echo BASE_URL_BACKEND.'/'.$controller.'/doAddCareer'; ?>" method="post" class="form-horizontal" role="form">
                                  <?php if(isset($error)){ ?>
                               ...
                               <div class="form-group">
                                      ...
                                      <div class="col-lg-4">
                                          <input name="career_title" type="text" class="form-control" placeholder="Career Title" value="<?php if(!empty($career_title)){echo $career_title;} ?>">
                                      </div>
                                </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea id="IDcareershortdesc" name="career_shortdesc" class="form-control" placeholder="About Short Description" rows="4"><?php if(!empty($career_shortdesc)){echo $career_shortdesc;} ?></textarea>
                                        <script>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                    <textarea id="IDcontentdesc" name="career_desc" class="form-control ckeditor" placeholder="Career Description" rows="7"><?php if(!empty($career_desc)){echo $career_desc;} ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="dtp_input1" name="career_publish_date" value="<?Php echo date("Y-m-d H:i:s");?>" /><br/>
                                </div>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-lg-4">
                                          <input name="career_alias" type="text" class="form-control" placeholder="Career Alias" value="<?php if(!empty($career_alias)){echo $career_alias;} ?>">
                                      </div>
                                </div>
				<div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Career Meta Description</label>
                                    <div class="col-lg-4">
                                        <input name="career_metadescription" type="text" class="form-control" placeholder="Career Meta Description" value="<?php if(!empty($career_metadescription)){echo $career_metadescription;} ?>">
                                    </div>
                                </div>
				<div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Career Meta Keywords</label>
                                    <div class="col-lg-4">
                                          <input name="career_metakeywords" type="text" class="form-control" placeholder="Career Meta Keywords" value="<?php if(!empty($career_metakeywords)){echo _metakeywords;} ?>">
                                    </div>
                                </div>
                                  <div class="form-group">
