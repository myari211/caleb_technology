          ...
          <section class="wrapper">
              ...
              <div class="row">
                ...
                <section class="panel">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Latest_training Title</label>
                                      <div class="col-lg-4">
                                          <input name="latest_training_title" type="text" class="form-control" placeholder="Latest_training Title" value="<?php if(!empty($latest_training_title)){echo $latest_training_title;} ?>">
                                      </div>
                                </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-4">
                                           <div style="margin-bottom:10px;" class="imageurl">
                                                ...
                                                <input type="text" name="latest_training_imageurl" readonly="readonly" id="imageurl" class="form-control" value="<?php if(!empty($contentimageurl)){echo $contentimageurl;} ?>" onchange="setVal(this);">
				...
				<div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input name="latest_training_metadescription" type="text" class="form-control" placeholder="Latest_training Meta Description" value="<?php if(!empty($latest_training_metadescription)){echo $latest_training_metadescription;} ?>">
                                    </div>
                                </div>
				<div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Latest_training Meta Keywords</label>
                                    <div class="col-lg-4">
                                          <input name="latest_training_metakeywords" type="text" class="form-control" placeholder="Latest_training Meta Keywords" value="<?php if(!empty($latest_training_metakeywords)){echo $latest_training_metakeywords;} ?>">
                                    </div>
                                </div>
                                  <div class="form-group">
