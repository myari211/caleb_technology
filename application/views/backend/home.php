 ...
 <style>
	...
	body {
		...
		background-image: url('../assets/img/bg_footer_cms.png');
                      ...
                      <div class="panel-body">
                          <div class="row invoice-list">
                              ...
                              <div class="col-lg-6 col-sm-4">
                                  ...
                                  <p>
                                      Company : <?php echo PROJECT_NAME; ?><br>
							  ...
							  <div class="col-lg-6 col-sm-4">
                                  ...
                                  <p>
									<a class="btn btn-warning btn-lg" target="_blank" href="<?php echo BASE_URL?>/assets/pdf/CMS_Manual_Web.pdf"><img src="<?php echo IMG_BASE_URL;?>/pdf.png"> Download </a>
                                  </p>
                              </div>
                          </div>
                      </div>
