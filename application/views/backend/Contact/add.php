                ...
                <section class="panel">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Contact Title</label>
                                      <div class="col-lg-4">
                                          <input name="contact_title" type="text" class="form-control" placeholder="Contact Title" value="<?php if(!empty($contact_title)){echo $contact_title;} ?>">
                                      </div>
                                </div> 
                                  <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Contact Name</label>
                                    <div class="col-lg-4">
                                        <input name="contact_name" type="text" class="form-control" placeholder="Contact Name" value="<?php if(!empty($contact_name)){echo $contact_name;} ?>">
                                    </div>
                                </div>  
                                <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Contact Email</label>
                                    <div class="col-lg-4">
                                        <input name="contact_email" type="email" class="form-control" placeholder="Contact Email" value="<?php if(!empty($contact_email)){echo $contact_email;} ?>">
                                    </div>
                                </div> 
				<div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Contact Phone</label>
                                    <div class="col-lg-4">
                                        <input name="contact_phone" type="text" class="form-control" placeholder="Contact Phone" value="<?php if(!empty($contact_phone)){echo $contact_phone;} ?>">
                                    </div>
                                </div>
				<div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Contact Fax</label>
                                    <div class="col-lg-4">
                                          <input name="contact_fax" type="text" class="form-control" placeholder="Contact Fax" value="<?php if(!empty($contact_fax)){echo $contact_fax;} ?>">
                                    </div>
                                </div>
                                  <div class="form-group">
