                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                          ...
                          <div class="panel-body">
                                    <form name="form1" action="<?php echo BASE_URL_BACKEND.'/testimonial/doAdd'; ?>" method="post" class="form-horizontal" role="form">
                                  <?php if(isset($error)){ ?>
                                  ...
                                  <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Testimonial Desc</label>
                                      <div class="col-lg-10">
										  <textarea id="IDpagesshortdesc" name="testimonial_desc" class="form-control" placeholder="Pages Short Description" rows="4"><?php if(!empty($testimonial_desc)){echo $testimonial_desc;} ?></textarea>
										  <script>
