                      ...
                      <section class="panel">
						  ...
						  <div class="panel-body">
							<div class="col-lg-12">
								...
								<?php } ?>
                                                              <?php if($order){ ?>
									<input class="btn btn-primary btn-sm" id="btn_order" type="button" value="Order" onClick="javascript:updateOrder()"><br><br>
								<?php } ?>
							</div>
						  </div>
                               ...
                               <form name="formAssignment" method="POST" action="" onsubmit="return false;">
                                ...
                                <table class="table table-bordered table-striped table-condensed table-hover">
                                  ...
                                  <tr>
                                      ...
                                      <th class="no-sort"><?php echo $breadcrump['module_name']; ?> Header Images</th> 
