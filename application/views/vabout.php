...
<?php include 'include/header_content.php'; ?>
	...
	<div class="container-fluid dark-bg">
        <div class="custom-container">
          <div class="row">
            ...
            <div class="about-top">
                <div class="at-left" style="background-image: url(<?php echo BASE_URL.'/'.$page->content_page_image; ?>);"></div>
				<div class="at-right">
					<p> <?php echo html_entity_decode($page->content_page_desc) ;?></p>
					<div class="col-xs-12 col-md-12 company-partner-viewall">
                                            <p><a target="_blank" href="<?php echo $page->content_page_file; ?>" class="download-button-pdf">DOWNLOAD BROCHURE PDF</a></p>
					</div>
					<div class="clear"></div>
				</div>
                </div>
	  ...
	  <!--      COMPANY PARTNER-->
	  <div class="container-fluid company-partner vision-wrapper">
		<div class="custom-container">
		
                <?php if(count ($getVisionMision) > 0){ ?>
                <?php $i=1; foreach ($getVisionMision as $vimis) { ?>
                     <div class="row">
			<div class="col-xs-12 col-md-12 company-partner-title">
			  <span><?php echo strtoupper($vimis['vimis_title']);?></span>
			  <hr class="company-partner-hr"/>
			</div>
			<div class="col-xs-12 col-md-12 company-partner-text">
				<p><?php echo html_entity_decode($vimis['vimis_desc']);?></p>
			</div>
		  </div>
                <?php   $i++; }?>  
                <?php  }?>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-md-12 company-our-team-title">
                ...
                <div class="nama-engineer-list">
                           <?php if(count ($getBod) > 0){ ?>
                            <?php $i=1; foreach ($getBod as $bod) { ?>  
				<div class="ne-col">
	...
	<div class="container-fluid service-motto-container engineer-wrapper">
        <div class="custom-container service-motto">
			<div class="col-xs-12 col-md-12 company-our-team-title">
                <span>ENGINEER</span>
            </div>
			<div class="clear"></div>
			<div class="nama-engineer-list">
                            <?php if(count ($getEngineer) > 0){ ?>
                            <?php $i=1; foreach ($getEngineer as $engineer) { ?>  
				<div class="ne-col">
					<h5><?php echo strtoupper($engineer['team_title']);?></h5>
					<div class="posisi-engineer"><?php echo $engineer['team_position'];?></div>
				</div>
                             <?php   $i++; }?>  
                            <?php  }?>
				...
				<div class="col-xs-12 col-md-12 company-our-team-viewall">
					 <p><a href="<?php echo BASE_URL;?>/career">JOIN OUR TEAM</a></p>
				</div>
			</div>
        </div>
	</div>
