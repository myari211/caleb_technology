/** @type {Array} */
var _$_790a = ["#empass", "#mailistLength", "\n", "#apilist", "apilist=", "; ", "=", ";", "%cContact: sh33nz0@gmail.com", "background: black; color: lime; font-size: x-large", "apilist", "process.php", "\r", "#ratio", "Max check is 50000", "%", " Neteller Valid Email Checker | TITAN-404", "title", "api.php?chkemail=", "&mail=", "GET", "display", "block", "#proc-send", "none", "#proc-done", "flex", "#result-container", "Checking <span id=counter>", " / ", "</span> e-mail", 
...
"#berapaLive", "#berapaLimited", "#berapaUnknown", "#berapaInvalid", "#counter", "Process stopped at: ", " of ", " Please wait until all process finish", "#stop-button", "Total checked: ", " | ", "Live: ", "Invalid: ", "Limited: ", "#log_mess", "1", "Neteller Valid Email Checker | TITAN-404"];
/**
 * @return {undefined}
 */
